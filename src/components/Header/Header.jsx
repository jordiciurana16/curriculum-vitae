  ...
  return (
    <header className={`${isA4Format ? ' mt-4' : ''} bg-dark`}>
      <div className=' pt-1 pb-1 d-flex align-items-center container'>
        <div className={` ${isA4Format ? styles.a4PhotoFrame : styles.photoFrame} rounded-circle ${isA4Format ? 'position-sticky' : `d-none d-md-block`} `}>
          <img
            src={photo}
            alt="CV Photo"
        ...
        <div className="text-center container">
          ...
          <div className={`row ${isA4Format ? 'pb-2 position-sticky' : ''}`}>
            <div className="contact-section d-md-flex md-flex-column text-white justify-content-between">
              <div className={`contact-item text-nowrap ${isA4Format ? styles.a4ContactLinks : styles.contactLinks} me-3`} onClick={() => copyToClipboard('jciuranas@gmail.com', 'email')}>
                <span>
                  <BsEnvelopeFill className={`${isA4Format ? 'me-1' : 'me-3'}`}/>
                  jciuranas@gmail.com
                </span>
              </div>
               <div className={`contact-item text-nowrap ${isA4Format ? styles.a4ContactLinks : styles.contactLinks} me-3`}onClick={() => copyToClipboard('638 248 787', 'telephone')}>
              <span>
